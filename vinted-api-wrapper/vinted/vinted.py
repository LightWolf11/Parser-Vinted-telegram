...
class Vinted:
    def __init__(
        ...
        # Initialize cloudscraper session with certifi CA bundle to avoid
        # macOS "unable to get local issuer certificate" errors when
        # python.org builds ship without a default trust store.
        ssl_context = ssl.create_default_context(cafile=certifi.where())
        self.scraper = cloudscraper.create_scraper(ssl_context=ssl_context)
